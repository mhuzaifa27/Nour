...
import com.jobesk.nourv.locator.ui.adapter.BeaconAdapter;
import com.jobesk.nourv.locator.ui.adapter.DetectedBeaconAdapter;
import com.jobesk.nourv.locator.ui.view.ContextMenuRecyclerView;
import com.jobesk.nourv.locator.ui.view.DividerItemDecoration;
...
public class DetectedBeaconsFragment extends ScanFragment implements BeaconAdapter.OnBeaconLongClickListener {
    ...
    public void onBeaconLongClick(int position) {
        getContext().startActivity(new Intent(getContext(), LinkProductActivity.class));
