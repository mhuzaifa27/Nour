...
package com.jobesk.nourv.locator.ui.view;
...
import com.jobesk.nourv.locator.util.AngleLowpassFilter;
...
public class RadarScanView extends View implements SensorEventListener {
    ...
    public RadarScanView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mGridPaint.setColor(getResources().getColor(R.color.colorPrimaryDark));
